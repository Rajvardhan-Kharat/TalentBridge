...
const PLANS = [
  {
    ...
    badge: '🆓', frame: 'none',
    features: ['Basic profile','5 applications/month','3 AI searches/day','1 resume template','Community access'],
  ...
  },
  {
    ...
    features: ['Unlimited applications','20 AI searches/day','5 resume templates','Gold profile frame','Priority listing','Advanced analytics','Email job alerts','LinkedIn optimization tips'],
    limits: [],
  },
  {
    ...
    features: ['Everything in Gold','Unlimited AI searches','All 15+ templates','Diamond profile frame','Featured candidate','Direct recruiter messaging','AI career coach','5 interview prep sessions/month','Salary negotiation toolkit','24/7 priority support'],
    limits: [],
  },
];
